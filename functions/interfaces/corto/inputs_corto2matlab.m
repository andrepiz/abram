function [alpha, d_body2cam, d_body2sun, q_CSF2IAU, q_CAMI2CAM] = inputs_corto2matlab(inputs_corto, scaling_blender, flag_debug)
...
d_body2cam = vecnorm(pos_body2cam_BL);

% Directions
dir_body2sun_BL = pos_body2sun_BL./d_body2sun;
dir_body2cam_BL = pos_body2cam_BL./d_body2cam;

% Alpha angle
alpha = acos(dot(dir_body2sun_BL,dir_body2cam_BL));
...
dcm_BL2CAM(3,1:3,:) = reshape(zCAM_BL, 3, []);
