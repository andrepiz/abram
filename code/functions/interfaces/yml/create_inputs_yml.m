...
body.map.normal.filename = 'lnormal_4.png';
...
params.gridding.method = 'weightedsum'; 
params.gridding.algorithm = 'area';
params.gridding.interpolation = 'linear';

params.reconstruction.granularity = 1;
params.reconstruction.filter = 'bilinear';
params.reconstruction.antialiasing = true;
