function [q_REF2CAMI, dcm_REF2CAMI, ixs_flip] = cami(dir_body2star_REF, dir_body2cam_REF)
...
% --- Enforce CAMI Y-axis always point downward emisphere
ixs_flip = yCAMI_REF(3,:) > 0;
yCAMI_REF(:, ixs_flip) = -yCAMI_REF(:, ixs_flip);
